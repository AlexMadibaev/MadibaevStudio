...
const copy = {
  ru: {
    ...
    contactTitle: "Есть задача, которую нужно превратить в работающую систему?",
  ...
  en: {
    ...
    contactTitle: "Have a challenge that needs to become a working system?",
